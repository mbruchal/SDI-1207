...
var me = {
          ...
          getAge: function () {     //Accessor Method
            return me.weight;       //Return Number
          },
          getName: function () {    //Accessor Method
            return me["name"];      //Return String
          },
          train: function (workOutType) {     //Method Procedure, Argument Object
              console.log ("This is my 2nd Arnold classic BodyBuilding Competition in Northern California.");
          ...
          weightGoal: function (heavy, light) {     //Method Function, Argument String
              while (me.weight <= 210) {      //while loop
                console.log ("Eating more protein to make weight. " + me.weight + " pounds and counting....");
                  ...
                  result = heavy + " is perfect. " + light + " was way too light.";
...
console.log ("Most people lose weight to compete, but like arnold did, I need to gain weight. I weigh only " + me.getAge() + " pounds and need to be at 210.");
me.train(exRoutine.exercisePlan[0]);
console.log ("There's other competitions in " + destination1 + ", " + destination2 + ", and " + destination3 + ".");
...
var weightWatch = me.weightGoal("210 Ibs.", "195 Ibs.");
